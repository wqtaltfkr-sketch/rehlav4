...
// ⚠️ مهم: ارفع هذا الرقم (v4 → v5 → ...) في كل مرة تُعدّل فيها أي ملف JS/CSS
...
// ============================================================
const CACHE_NAME = "rehla-cache-v15"; // v14 → v15: Sprint 1 (نظام الأدوار role + تحديث نموذج is_supervisor في الواجهة) + Sprint 2 (شاشة "قائمة التجهيزات" الجديدة #checklist)
